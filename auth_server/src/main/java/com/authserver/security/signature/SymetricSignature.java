...
public class SymetricSignature {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String urlRelative = "/api/v1/b2b/balance";
        String accessToken = "eyJhbGciOiJIUzI1NiJ9.eyJqdGkiOiIwODlmOTEzZS03ZmQwLTQ2NjctOWM5MS03YzhlODhjMzFkNzEiLCJjbGllbnRJZCI6Im15LWNsaWVudC1pZCIsInNjb3BlIjoiQjJCIiwiaWF0IjoxNzc5ODgxMTY5LCJuYmYiOjE3Nzk4ODExNjksImV4cCI6MTc3OTg4NDc2OX0.0VW4-gf17n2rKbeKCwRAt_UVN4bW6Dt_Gch-BqoF0T0";
        String body = "{\n" +
